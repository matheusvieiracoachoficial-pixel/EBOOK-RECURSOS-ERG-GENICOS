    ...
    <section id="pricing" className="py-24 bg-black px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-sm font-black text-primary tracking-[0.4em] uppercase italic">Acesso Vitalício</h2>
          <h3 className="text-4xl md:text-7xl font-black text-foreground font-display uppercase italic leading-none tracking-tighter">
            OFERTA DE <span className="text-gradient">LANÇAMENTO.</span>
          </h3>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto italic">
            Garanta seu exemplar do eBook com as ferramentas de elite pelo menor preço histórico.
          </p>
        </div>
          ...
          <div className={cn(
            ...
            <div className="absolute -top-5 left-1/2 -translate-x-1/2 px-6 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-xl bg-gradient-to-r from-primary to-orange-400 text-black animate-pulse">
              <span className="flex items-center gap-2">
                ...
                Destaque: PROTOCOLO ESSENCIAL
              </span>
            </div>

            <div className="mb-8 flex items-center justify-between">
              <div className="space-y-1">
                <h4 className="text-3xl font-black text-foreground uppercase italic tracking-tighter leading-none">eBook Força Proibida</h4>
                <p className="text-xs text-muted-foreground font-medium italic">O manual que a elite não quer que você leia.</p>
              </div>
            ...
            <div className="mb-8">
              ...
              {!isExpired && (
                <p className="text-[10px] text-muted-foreground font-black uppercase tracking-widest mt-2 italic">
            ...
            <ul className="space-y-4 mb-10">
              {[
                ...
                "Fundamentos da Performance Bioquímica",
                "Guia de Segurança e Redução de Danos",
